...
public class TaskActionController {
    ...
    public ResponseEntity<TaskActionDto> create(@RequestHeader(value = ApiConstant.AUTHENTICATED_USER_ID) Long authenticatedUserId,
                                                @PathVariable Long taskId,
                                                @Valid @RequestBody TaskActionRequest request) throws ActionNotFoundException, YouDoNotHavePermissionException, TaskNotFoundException, StartUpActionException, NotNextActionException {
